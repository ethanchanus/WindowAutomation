namespace Loupedeck.WindowAutomationPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.WindowAutomationPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.WindowAutomationPlugin.Resources.Resource.txt`.
